    ...
    <main className="flex min-h-screen flex-col items-center p-24 gap-5">
      ...
      <div style={styles.container}>
        <h1 style={styles.header}>
          Welcome to NeoSwap Bundles - Your Solana Games Companion
        </h1>
        <br />
        ...
        <ol>
          <li style={styles.instructions}>
            1) Connect your wallet by clicking on *Select Wallet* on the top of
            the page
          </li>
          <li style={styles.instructions}>
          ...
          <li style={styles.instructions}>
            3) Input in the according fields the required quantities of the
        ...
        <p style={styles.paragraph}>
          It was cumbersome to scroll the galactic market place to find the
          cheapest resources that can extend my expedition in the fastest way.
        </p>
        <br />
        <p style={styles.paragraph}>
          Fortunately, at NeoSwap we came up with an idea. We were empowered to
          craft a tool for the HyperDrive hackathon, enabling bulk purchases of
        ...
        <br />
        <p style={styles.paragraph}>
          The power of this tool is its streamlined transactions with a
          one-signature feature, saving precious time.
        </p>
        <br />
        <p style={styles.paragraph}>
